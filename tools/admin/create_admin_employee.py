...
def main():
    ...
    try:
        eid = db.create_employee(user_id=admin_id, name='Admin User', dob='1970-01-01', job_title='Administrator', role='admin', year_start=current_year, profile_pic=None, contract_type='full-time')
